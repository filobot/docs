...
如果要 啟用模組 ，您必須執行以下指令：<kbd>/anti-repeated-text enable</kbd>.

**範例**: <kbd>/anti-repeated-text enable</kbd>.
...
如果要 停用模組 ，您必須執行以下指令：<kbd>/anti-repeated-text disable</kbd>.

**範例**: <kbd>/anti-repeated-text disable</kbd>.

# Steps to set a sanction

## **步驟 1**: Set a sanction

如果要 set a sanction ，您必須執行以下指令：<kbd>/anti-repeated-text action ``action:<動作>``</kbd>.
...
**範例**: <kbd>/anti-repeated-text action ``action:Temporarily mute the user`` ``time:1h``</kbd>.

# 新增例外頻道的步驟

## **步驟 1**: 新增一個例外的頻道

如果要 新增一個例外的頻道 ，您必須執行以下指令：<kbd>/anti-repeated-text channel ``action:Add`` ``channel:<#頻道/頻道 ID>``</kbd>.

> 當您在打指令時，請勿包含 ``<>``.
{.is-warning}

**範例**: <kbd>/anti-repeated-text channel ``action:Add`` ``channel:#spam-allowed``</kbd>.
...
如果要 移除例外頻道 ，您必須執行以下指令：<kbd>/anti-repeated-text channel ``action:Remove`` ``channel:<#頻道/頻道 ID>``</kbd>.

> 當您在打指令時，請勿包含 ``<>``.
{.is-warning}

**範例**: <kbd>/anti-repeated-text channel ``action:Remove`` ``channel:#general``</kbd>.
...
如果要 新增例外身分組 ，您必須執行以下指令：<kbd>/anti-repeated-text role ``action:Add`` ``role:<@身分組/身分組 ID>``</kbd>.

> 當您在打指令時，請勿包含 ``<>``.
{.is-warning}

**範例**: <kbd>/anti-repeated-text role ``action:Add`` ``role:@Moderators``</kbd>.
...
如果要 移除例外身分組 ，您必須執行以下指令：<kbd>/anti-repeated-text role ``action:Remove`` ``role:<@身分組/身分組 ID>``</kbd>.

> 當您在打指令時，請勿包含 ``<>``.
{.is-warning}

**範例**: <kbd>/anti-repeated-text role ``action:Remove`` ``role:@Moderators``</kbd>.
...
如果要 重置模組 ，您必須執行以下指令：<kbd>/anti-repeated-text reset</kbd>.

**範例**: <kbd>/anti-repeated-text reset</kbd>.
