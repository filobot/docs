...
To enable the module you must execute the following command: <kbd>/anti-scam-links enable</kbd>.

**Example**: <kbd>/anti-scam-links enable</kbd>.
...
To disable the module you must execute the following command: <kbd>/anti-scam-links disable</kbd>.

**Example**: <kbd>/anti-scam-links disable</kbd>.
...
**Example**: <kbd>/anti-scam-links aggresive-filter ``action:Enable``</kbd>.
...
**Example**: <kbd>/anti-scam-links aggresive-filter ``action:Disable``</kbd>.

# Steps to set a sanction

## **Step 1**: Set a sanction

To set a sanction you must execute the following command: <kbd>/anti-scam-links action ``action:<Action>``</kbd>.
...
**Example**: <kbd>/anti-scam-links action ``action:Temporarily mute the user`` ``time:1h``</kbd>.

# Steps to add a channel to the allowed list

## **Step 1**: Add a channel to the allowed list

To add a channel to the allowed list you must execute the following command: <kbd>/anti-scam-links channel ``action:Add`` ``channel:<#Channel/Channel ID>``</kbd>.

> Don't include ``<>`` when you're running the command.
{.is-warning}

**Example**: <kbd>/anti-scam-links channel ``action:Add`` ``channel:#spam-allowed``</kbd>.
...
To remove a channel to the allowed list you must execute the following command: <kbd>/anti-scam-links channel ``action:Remove`` ``channel:<#Channel/Channel ID>``</kbd>.

> Don't include ``<>`` when you're running the command.
{.is-warning}

**Example**: <kbd>/anti-scam-links channel ``action:Remove`` ``channel:#general``</kbd>.
...
To add a role to the allowed list you must execute the following command: <kbd>/anti-scam-links role ``action:Add`` ``role:<@Role/Role ID>``</kbd>.

> Don't include ``<>`` when you're running the command.
{.is-warning}

**Example**: <kbd>/anti-scam-links role ``action:Add`` ``role:@Moderators``</kbd>.
...
To remove a role to the allowed list you must execute the following command: <kbd>/anti-scam-links role ``action:Remove`` ``role:<@Role/Role ID>``</kbd>.

> Don't include ``<>`` when you're running the command.
{.is-warning}

**Example**: <kbd>/anti-scam-links role ``action:Remove`` ``role:@Moderators``</kbd>.
...
To reset the module settings you must execute the following command: <kbd>/anti-scam-links reset</kbd>.

**Example**: <kbd>/anti-scam-links reset</kbd>.
