...
Este módulo sancionará a aquellos usuarios que envíen demasiados mensajes en poco tiempo o mensajes idénticos en poco tiempo.
...
Para habilitar el módulo debes ejecutar el siguiente comando: <kbd>/anti-spam enable</kbd>.

**Ejemplo**: <kbd>/anti-spam enable</kbd>.
...
Para deshabilitar el módulo debes ejecutar el siguiente comando: <kbd>/anti-spam disable</kbd>.

**Ejemplo**: <kbd>/anti-spam disable</kbd>.
...
Para establecer una sanción debes ejecutar el siguiente comando: <kbd>/anti-spam action ``action:<Acción>``</kbd>.
...
**Ejemplo**: <kbd>/anti-spam action ``action:Temporarily mute the user`` ``time:1h``</kbd>.

# Steps to add a channel to the allowed list

## **Paso 1**: Add a channel to the allowed list

Para add a channel to the allowed list debes ejecutar el siguiente comando: <kbd>/anti-spam channel ``action:Add`` ``channel:<#Canal/ID del Canal>``</kbd>.

> No incluyas ``<>`` cuando estés ejecutando el comando.
{.is-warning}

**Ejemplo**: <kbd>/anti-spam channel ``action:Add`` ``channel:#spam-allowed``</kbd>.
...
Para remove a channel to the allowed list debes ejecutar el siguiente comando: <kbd>/anti-spam channel ``action:Remove`` ``channel:<#Canal/ID del Canal>``</kbd>.

> No incluyas ``<>`` cuando estés ejecutando el comando.
{.is-warning}

**Ejemplo**: <kbd>/anti-spam channel ``action:Remove`` ``channel:#general``</kbd>.
...
Para add a role to the allowed list debes ejecutar el siguiente comando: <kbd>/anti-spam role ``action:Add`` ``role:<@Rol/ID del Rol>``</kbd>.

> No incluyas ``<>`` cuando estés ejecutando el comando.
{.is-warning}

**Ejemplo**: <kbd>/anti-spam role ``action:Add`` ``role:@Moderators``</kbd>.
...
Para remove a role to the allowed list debes ejecutar el siguiente comando: <kbd>/anti-spam role ``action:Remove`` ``role:<@Rol/ID del Rol>``</kbd>.

> No incluyas ``<>`` cuando estés ejecutando el comando.
{.is-warning}

**Ejemplo**: <kbd>/anti-spam role ``action:Remove`` ``role:@Moderators``</kbd>.
